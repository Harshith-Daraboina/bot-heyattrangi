...
def generate_report(memory):
    ...
    # NOTE: We do NOT inject RAG context here. 
    # The report should be based ONLY on the actual conversation to avoid 
    # hallucinating that the user matches the case studies in the knowledge base.
